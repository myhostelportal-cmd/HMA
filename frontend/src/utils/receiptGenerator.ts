...
export const downloadReceipt = (student: StudentProfile, fee: FeeRecord, feeStats: FeeStats) => {
  if (!student) return;
  ...
  doc.text("1. This is a computer-generated receipt and does not require a physical signature.", 20, footerY - 6);
  doc.text("2. Please keep this receipt for future reference regarding your hostel stay.", 20, footerY - 2);
  ...
  doc.setFontSize(7);
  doc.setFont("helvetica", "normal");
  doc.text(student.hostel_name || "Hostel Management", pageWidth - 45, footerY + 9, { align: 'center' });
