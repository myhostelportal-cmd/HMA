                ...
                <div key={hostel.hostel_id} className="space-y-12">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8">
                    {[
                      ...
                      { id: 'revenue', label: 'Pending Fees', value: `₹${Math.floor(financeStats[hostel.hostel_id]?.pendingFees || 0).toLocaleString()}`, color: 'text-indigo-600', icon: TrendingUp, bg: 'bg-indigo-50', border: 'border-indigo-100', accent: 'bg-indigo-500', shadow: 'shadow-indigo-200/40', glow: 'group-hover:shadow-indigo-500/20' },
